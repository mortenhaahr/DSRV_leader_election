...
class JsonParserTest(unittest.TestCase):
    def test_json_parse_config_dict_valid(self) -> None:
        ...
        for i, config in enumerate(valid_configs):
            with self.subTest(i=i):
                ...
                # All filters should be Filter objects
                for f in result["filters"]:
                    self.assertTrue(hasattr(f, "filter"))

    def test_json_parse_config_dict_invalid(self) -> None:
